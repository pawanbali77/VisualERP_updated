...
public partial class UserControls_Supplier : System.Web.UI.UserControl
{
    ...
    public int ProcessObjectId
    {
        ...
        ViewState["SupplierPoid"] = _ProcessObjectId;
        }
    }
    ...
    {
        divSupplier.Style.Add("top", _Top.ToString() + "px");
        divSupplier.Style.Add("left", _Left.ToString() + "px");
        divSupplier.InnerText = _Title;
        lnkbtnDeleteSupplier.Style.Add("top", "43px");
        lnkbtnDeleteSupplier.Style.Add("left", "0px");

       // divSupplier.Attributes["name"] = _SupplierId;
    }

    protected void lnkbtnDeleteSupplier_Click1(object sender, EventArgs e)
    {
        int processobjId = 0;
        processobjId = this.CInt32(ViewState["SupplierPoid"]);
        if (processobjId > 0)
        {
            bool result = false;
