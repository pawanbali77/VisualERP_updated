...
public partial class UserControls_Shipment : System.Web.UI.UserControl
{
    ...
    public int ProcessObjectId
    {
        ...
        ViewState["ShipmentPoid"] = _ProcessObjectId;
        }
    }
    ...
    {
        divShipment.Style.Add("top", _Top.ToString() + "px");
        divShipment.Style.Add("left", _Left.ToString() + "px");
       // divShipment.Attributes["name"] = _ShipmentId;
        divShipment.InnerText = _Title;
        lnkbtnDeleteShipment.Style.Add("top", "50px");
        lnkbtnDeleteShipment.Style.Add("left", "5px");
    }

    protected void lnkbtnDeleteShipment_Click1(object sender, EventArgs e)
    {
        int processobjId = 0;
        processobjId = this.CInt32(ViewState["ShipmentPoid"]);
        if (processobjId > 0)
        {
            bool result = false;
