        ...
        <div class="AttribWrpIn">
            ...
            <div class="AttribMid1">
                <div style="height: 30px; font-weight: bold; text-decoration: underline;">
                    <a href="javascript:OpenPopup('divTFG');" id="hrefAdd" style="margin: 0px 0px 0px 15px;
                        display: none">Add TFG Information</a>
                    <asp:LinkButton ID="lnkbtnOpenDiv" runat="server" Text="Add TFG Information" Style="margin: 0px 0px 0px 15px;
                        color: Orange" OnClick="lnkbtnOpenDiv_Click" />
