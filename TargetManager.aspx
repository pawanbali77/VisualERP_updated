<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TargetManager.aspx.cs" Inherits="TargetManager"
            ...
            <div class="right_container">
                ...
                <div class="right_container_top" id="Title">
                 ...
                 <asp:Button ID="btnDesignView" runat="server" Text="Design View" class="BlackBtnLe" 
                    ...
                    <div class="right_nav">
                        <ul>
                            <li runat="server" id="liDesignViewBtn"><a href="Production.aspx?src=tgt" class="DesignBtn" style="font: bold 20px Arial;line-height: 44px !important;">Design View</a></li>
                            ...
                            <li id="liSummary" runat="server" style="height: 44px; margin-top: 6px;"><a title="Summary functions"
                                class="SummaryIcon" href="SummaryTable.aspx?src=tgt"></a></li>
                        </ul>
